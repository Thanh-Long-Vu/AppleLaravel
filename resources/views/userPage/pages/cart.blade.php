                                        ...
                                        <div class="mt-1">
                                            ...
                                            <div class="collapse mb-3" id="collapseExample">
                                                <div class="form-group mb-4">
                                                    <div
                                                        class="dropdown bootstrap-select js-select dropdown-select right-dropdown-0-all w-100">
                                                        <select
                                                            ...
                                                            class="btn dropdown-toggle bs-placeholder bg-white font-weight-normal border border-color-1 text-gray-20"
                                                            data-toggle="dropdown" role="button" title="Select a country…">
                                                ...
                                                <div class="form-group mb-4">
                                                    <div
                                                        ...
                                                        <select
                                                            ...
                                                            class="btn dropdown-toggle bs-placeholder bg-white font-weight-normal border border-color-1 text-gray-20"
                                                            data-toggle="dropdown" role="button" title="Select an option…">
                                                            <div class="filter-option">
                                                                <div class="filter-option-inner">
                                                                    <div class="filter-option-inner-inner">Select an option…
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </button>
