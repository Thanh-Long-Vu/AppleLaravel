        ...
        <div id="primary" class="content-area">
            <main id="main" class="site-main">
                <div class="home-v1-slider">
                    ...
                    <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm owl-loaded owl-drag">
                        ...
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-4608px, 0px, 0px); transition: all 0s ease 0s; width: 10752px;"><div class="owl-item cloned" style="width: 1536px;"><div class="item" style="background-image: url(assets/images/slider/banner-1.jpg);">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-5">
                                                    <div class="caption vertical-center text-left">
                                                        <div class="hero-subtitle-v2 fadeInDown-1" style="opacity: 0; top: -15px;">
                                                            shop to get what you loves
                                                        </div>

                                                        <div class="hero-2 fadeInDown-2" style="opacity: 0; top: -15px;">
                                                            Timepieces that make a statement up to <strong>40% Off</strong>
                                                        </div>

                                                        <div class="hero-action-btn fadeInDown-3" style="opacity: 0; top: -15px;">
                                    ...
                                    </div></div><div class="owl-item cloned" style="width: 1536px;"><div class="item" style="background-image: url(assets/images/slider/banner-3.jpg);">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-5">
                                                    <div class="caption vertical-center text-left">
                                                        <div class="hero-subtitle-v2 fadeInLeft-1" style="opacity: 0; left: 15px;">
                                                            shop to get what you loves
                                                        </div>

                                                        <div class="hero-2 fadeInRight-1" style="opacity: 0; left: -15px;">
                                                            Timepieces that make a statement up to <strong>40% Off</strong>
                                                        </div>

                                                        <div class="hero-action-btn fadeInLeft-2" style="opacity: 0; left: 15px;">
                                                            <a href="single-product.html" class="big le-button ">Start Buying</a>
                                                        </div>
                                                    </div><!-- /.caption -->
                                                </div>
                                    ...
                                    </div></div><div class="owl-item" style="width: 1536px;"><div class="item" style="background-image: url(assets/images/slider/banner-2.jpg);">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-5">
                                                    <div class="caption vertical-center text-left">
                                                        <div class="hero-1 fadeInDown-1" style="opacity: 1; top: 0px;">
                                                            The New <br> Standard
                                                        </div>

                                                        <div class="hero-subtitle fadeInDown-2" style="opacity: 1; top: 0px;">
                                                            under favorable smartwatches
                                                        </div>
                                                        <div class="hero-v2-price fadeInDown-3" style="opacity: 1; top: 0px;">
                                                            from <br><span>$749</span>
                                                        </div>
                                                        <div class="hero-action-btn fadeInDown-4" style="opacity: 1; top: 0px;">
                                                            <a href="single-product.html" class="big le-button ">Start Buying</a>
                                                        </div>
                                                    </div><!-- /.caption -->
                                                </div>
                                    ...
                                    </div></div><div class="owl-item active" style="width: 1536px;"><div class="item" style="background-image: url(assets/images/slider/banner-1.jpg);">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-5">
                                                    <div class="caption vertical-center text-left">
                                                        <div class="hero-subtitle-v2 fadeInDown-1" style="opacity: 1; top: 0px;">
                                                            shop to get what you loves
                                                        </div>

                                                        <div class="hero-2 fadeInDown-2" style="opacity: 1; top: 0px;">
                                                            Timepieces that make a statement up to <strong>40% Off</strong>
                                                        </div>

                                                        <div class="hero-action-btn fadeInDown-3" style="opacity: 1; top: 0px;">
                                                            <a href="single-product.html" class="big le-button ">Start Buying</a>
                                                        </div>
                                                    </div><!-- /.caption -->
                                                </div>
                                    ...
                                    </div></div><div class="owl-item" style="width: 1536px;"><div class="item" style="background-image: url(assets/images/slider/banner-3.jpg);">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-5">
                                                    <div class="caption vertical-center text-left">
                                    ...
                                    </div></div><div class="owl-item cloned" style="width: 1536px;"><div class="item" style="background-image: url(assets/images/slider/banner-2.jpg);">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-5">
                                                    <div class="caption vertical-center text-left">
                                                        <div class="hero-1 fadeInDown-1" style="opacity: 0; top: -15px;">
                                                            The New <br> Standard
                                                        </div>

                                                        <div class="hero-subtitle fadeInDown-2" style="opacity: 0; top: -15px;">
                                                            under favorable smartwatches
                                                        </div>
                                                        <div class="hero-v2-price fadeInDown-3" style="opacity: 0; top: -15px;">
                                                            from <br><span>$749</span>
                                                        </div>
                                                        <div class="hero-action-btn fadeInDown-4" style="opacity: 0; top: -15px;">
                                                            <a href="single-product.html" class="big le-button ">Start Buying</a>
                                                        </div>
                                                    </div><!-- /.caption -->
                                                </div>
                                    ...
                                    </div></div><div class="owl-item cloned" style="width: 1536px;"><div class="item" style="background-image: url(assets/images/slider/banner-1.jpg);">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-5">
                                                    <div class="caption vertical-center text-left">
                                    ...
                                    </div></div></div></div><div class="owl-nav disabled"><div class="owl-prev">prev</div><div class="owl-next">next</div></div><div class="owl-dots"><div class="owl-dot"><span></span></div><div class="owl-dot active"><span></span></div><div class="owl-dot"><span></span></div></div></div><!-- /.owl-carousel -->
                ...
                <div class="home-v1-ads-block animate-in-view fadeIn animated" data-animation="fadeIn">
                    <div class="ads-block row">
                        <div class="ad col-xs-12 col-sm-4">
                            <div class="media">
                                <div class="media-left media-middle">
                                    <img src="assets/images/banner/cameras.jpg" alt="">
                                </div>
                        ...
                        <div class="ad col-xs-12 col-sm-4">
                            <div class="media">
                                <div class="media-left media-middle">
                                    <img src="assets/images/banner/MobileDevicesv2-2.jpg" alt="">
                                </div>
                                <div class="media-body media-middle">
                                    <div class="ad-text">
                        ...
                        <div class="ad col-xs-12 col-sm-4">
                            <div class="media">
                                <div class="media-left media-middle">
                                    <img src="assets/images/banner/DesktopPC.jpg" alt="">
                                </div>
                                <div class="media-body media-middle">
                                    <div class="ad-text">
                                ...
                                <div class="onsale-product">
                                    <a href="shop.html">
                                        <div class="product-thumbnail">
                                            <img class="wp-post-image" src="assets/images/onsale-product.jpg" alt=""></div>
                                    ...
                                    <div class="deal-countdown-timer">
                                        ...
                                        <div id="deal-countdown" class="countdown"><span data-value="-1590" class="days"><span class="value">-1590</span><b>Days</b></span><span class="hours"><span class="value">-17</span><b>Hours</b></span><span class="minutes"><span class="value">-49</span><b>Mins</b></span><span class="seconds"><span class="value">-44</span><b>Secs</b></span></div>
                                    ...
                                    <div class="woocommerce columns-3">
                                        ...
                                        <ul class="products columns-3">
                                            ...
                                            <li class="product first">
                                                <div class="product-outer" style="height: 362px;">
                ...
                <section class="section-product-cards-carousel animate-in-view fadeIn animated" data-animation="fadeIn">
                    ...
                    <div id="home-v1-product-cards-careousel">
                        <div class="woocommerce columns-3 home-v1-product-cards-carousel product-cards-carousel owl-carousel owl-loaded owl-drag">



                            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 2340px;"><div class="owl-item active" style="width: 1170px;"><ul class="products columns-3">
                                            <li class="product product-card first">

                                                <div class="product-outer" style="height: 214px;">
                                            ...
                                            <li class="product product-card ">
                                                ...
                                                <div class="product-outer" style="height: 214px;">
                                                    <div class="media product-inner">
                                                        ...
                                                        <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                                            <img class="media-object wp-post-image img-responsive" src="assets/images/product-cards/6.jpg" alt="">
                                                        </a>
                                            ...
                                            <li class="product product-card last">
                                                ...
                                                <div class="product-outer" style="height: 214px;">
                                                    <div class="media product-inner">
                                                        ...
                                                        <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                                            <img class="media-object wp-post-image img-responsive" src="assets/images/product-cards/5.jpg" alt="">
                                                        </a>
                                                            ...
                                                            <div class="price-add-to-cart">
                                                                <span class="price">
                                                                    <span class="electro-price" style="position: relative;">
                                                                        ...
                                                                        <del style="position:absolute;left:0;top:-14px;"><span class="amount">$4,780.00</span></del>
                                                                        <span class="amount"> </span>
                                                                    </span>
                                                                </span>
                                            ...
                                            <li class="product product-card first">
                                                ...
                                                <div class="product-outer" style="height: 214px;">
                                                    <div class="media product-inner">
                                                        ...
                                                        <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                                            <img class="img-responsive media-object wp-post-image" src="assets/images/product-cards/1.jpg" alt="">
                                            ...
                                            <li class="product product-card ">
                                                ...
                                                <div class="product-outer" style="height: 214px;">
                                                    <div class="media product-inner">
                                                        ...
                                                        <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                                            <img class="img-responsive media-object wp-post-image" src="assets/images/product-cards/3.jpg" alt="">
                                                        </a>
                                            ...
                                            <li class="product product-card last">
                                                ...
                                                <div class="product-outer" style="height: 214px;">
                                                    <div class="media product-inner">
                                                        ...
                                                        <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                                            <img class="img-responsive media-object wp-post-image" src="assets/images/product-cards/2.jpg" alt="">
                                                        </a>
                                        ...
                                        </ul></div><div class="owl-item" style="width: 1170px;"><ul class="products columns-3">
                                            <li class="product product-card first">
                ...
                <section class="home-v1-recently-viewed-products-carousel section-products-carousel animate-in-view fadeIn animated" data-animation="fadeIn">
                    ...
                    <div id="recently-added-products-carousel">
                        <div class="woocommerce columns-6">
                            <div class="products owl-carousel recently-added-products products-carousel columns-6 owl-loaded owl-drag">
                                ...
                                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1560px;"><div class="owl-item active" style="width: 195px;"><div class="product">
                                                <div class="product-outer" style="height: 311px;">
                                                    <div class="product-inner">
                                                        <span class="loop-product-categories"><a href="product-category.html" rel="tag">Smartphones</a></span>
                                                        <a href="single-product.html">
                                                            <h3>Tablet Thin EliteBook  Revolve 810 G6</h3>
                                            ...
                                            </div></div><div class="owl-item active" style="width: 195px;"><div class="product">
                                                <div class="product-outer" style="height: 313px;">
                                                    <div class="product-inner">
                                                        <span class="loop-product-categories"><a href="product-category.html" rel="tag">Smartphones</a></span>
                                                        <a href="single-product.html">
                                            ...
                                            </div></div><div class="owl-item active last-active" style="width: 195px;"><div class="product">
                                                <div class="product-outer" style="height: 313px;">
                                                    <div class="product-inner">
                                                        <span class="loop-product-categories"><a href="product-category.html" rel="tag">Smartphones</a></span>
                                                        <a href="single-product.html">
                                            ...
                                            </div></div><div class="owl-item" style="width: 195px;"><div class="product">
                                                <div class="product-outer" style="height: 313px;">
                                                    <div class="product-inner">
                                                        <span class="loop-product-categories"><a href="product-category.html" rel="tag">Smartphones</a></span>
                                                        <a href="single-product.html">
                                            ...
                                            </div></div></div></div><div class="owl-nav"><div class="owl-prev disabled"></div><div class="owl-next"></div></div><div class="owl-dots"><div class="owl-dot active"><span></span></div><div class="owl-dot"><span></span></div></div></div>
                        </div>
                    </div>
                </section>
            </main><!-- #main -->
