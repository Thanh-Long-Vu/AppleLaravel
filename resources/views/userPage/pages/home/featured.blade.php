                ...
                <div class="product-item__inner px-xl-4 p-3">
                    <div class="product-item__body pb-xl-2">
                        <div class="mb-2"><a
                                ...
                                {{ $item->productType->category->name }} - Brand : {{ $item->productType->category->brand->name ?? "" }}</a></div>
                        ...
                        <div class="mb-2">
                            <a href="{{ route('products.show', ['product' => $item->id_product ?? 0]) }}"
                        ...
                        <div class="flex-center-between mb-1">
                            ...
                            @if ($item->active_quantity !== null && ($item->active_quantity - $item->quantity_sell) > 0 && $item->active_quantity != $item->quantity_sell)
                                ...
                                <div class="d-none d-xl-block prodcut-add-cart">
                                    <a onclick="addCart({{ $item->id_product }})"
