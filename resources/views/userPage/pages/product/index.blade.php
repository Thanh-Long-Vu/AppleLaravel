                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                            ...
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1">
                                <a
                                    href="{{ route('categories.show', [$product->productType->category->id_category ?? 0]) }}">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="mb-2">
                                <ul class="font-size-14 pl-3 ml-1 text-gray-110">
                                    <li class="line-clamp-1 mb-1 list-bullet"><b>Brand :
                                            {{ $product->productType->category->brand->name ?? '' }}</b></li>
                                    <li class="line-clamp-1 mb-1 list-bullet">Quality : <b style="color : red;">New Full Box
                                        </b></li>
                                    <li class="line-clamp-1 mb-1 list-bullet">Warranty : <b
                                            style="color : red;">{{ $product->warehouse->warranty ?? '' }} Month</b></li>
                                    ...
                                    @if ($product->discount != 0)
                                        <li class="line-clamp-1 mb-1 list-bullet">Discount :
                                            <b style="color : red;"
                                                class="font-size-15">{{ $product->discount ?? 0 }}%</b>
                                        </li>
                                    @endif
                                </ul>
                            </div>
                            ...
                            <div class="card p-5 border-width-2 border-color-1 borders-radius-17">
                                <div class="text-gray-9 font-size-14 pb-2 border-color-1 border-bottom mb-3">Availability:
                                    @if ($product->active_quantity !== null && $product->active_quantity - $product->quantity_sell > 0 && $product->active_quantity != $product->quantity_sell)
                                        <span
                                            class="text-green font-weight-bold">{{ $product->active_quantity - $product->quantity_sell ?? '' }}
                                            in stock</span>
                                    @else
                                ...
                                <div class="mb-3">
                                    @if ($product->discount !== null && $product->discount > 0)
                                        ...
                                        <div class="font-size-30">{{ number_format($product->currentPrice ?? '') }} $
                                        </div>
                                    @else
                                        <div class="font-size-30">{{ number_format($product->currentPrice ?? '') }} $
                                        </div>
                                ...
                                @if ($product->active_quantity !== null && $product->active_quantity - $product->quantity_sell > 0 && $product->active_quantity != $product->quantity_sell)
                                    <form>
                                                ...
                                                <div class="js-quantity row align-items-center">
                                                    <div class="col">
                                                        <input
                                                            ...
                                                            max="{{ $product->active_quantity - $product->quantity_sell }}"
                                                            readonly>
                                                    </div>
                                        ...
                                        <div class="mb-2 pb-0dot5">
                                            <a class="btn btn-block btn-primary-dark"
                                                onclick="addCart({{ $product->id_product }})" href="javascript:"><i
                                                    class="ec ec-add-to-cart mr-2 font-size-20"></i> Add to Car</a>
                                        </div>
                                    </form>
                                @endif
                            </div>
