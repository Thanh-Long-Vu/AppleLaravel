                ...
                <div class="product-item__body pb-xl-2">
                    ...
                    <h5 class="mb-1 product-item__title">
                        ...
                        <a href="{{ route('products.show', ['product' => $product->id_product]) }}"
                            ...
                            <b style="color: {{ $colors[(int) $product->warehouse->color]['color'] ?? 'grey' }}; "
                                class="mx-1">{{ $colors[(int) $product->warehouse->color]['name'] ?? '' }}
                            </b> -
                            <b class="mx-1">
                    ...
                    <div class="mb-2">
                        <a href="{{ route('products.show', ['product' => $product->id_product]) }}"
                            ...
                            <img class="img-fluid img-product" src="../{{ $product->thumbnail }}"
                    ...
                    <ul class="font-size-12 p-0 text-gray-110 mb-4">
                        ...
                        <li class="line-clamp-1 mb-1 list-bullet">Warranty : <b
                                style="color : red;">{{ $product->warehouse->warranty ?? 0 }} Month</b></li>
                    </ul>
                    <div class="flex-center-between mb-1">
                        ...
                        @else
                            <a href="{{ route('index.contact') }}" class="btn-add-cart btn-danger transition-3d-hover">
