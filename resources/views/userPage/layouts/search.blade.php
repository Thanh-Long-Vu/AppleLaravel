            ...
            <div class="col-auto">
                ...
                <nav
                    ...
                    <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center "
                        href="{{ route('home') }}" style="margin : 0 auto">
                        <img src="assets/img/logo-page.png" alt="logo-page-apple" style="width : 40%">
                    </a>
                    <!-- End Logo -->
                ...
                <form class="js-focus-state" action="{{ route('resultSearch') }}" method="get">
                    ...
                    <div class="input-group">
                        <input type="text"
                            ...
                            name="productType" id="productType" placeholder="Search for Products"
                            aria-label="Search for Products" aria-describedby="searchProduct1" required>
                        <div class="input-group-append">
                            <!-- Select -->
                            <select id="category_id" name="category_id" onchange="fetch_select(this.value);"
            ...
            <div class="col col-xl-auto text-right text-xl-left pl-0 pl-xl-3 position-static">
                <div class="d-inline-flex">
                    <ul class="d-flex list-unstyled mb-0 align-items-center">
                        ...
                        <!-- End Search -->
                        <li class="col d-xl-none px-2 px-sm-3"><a href="" class="text-gray-90" data-toggle="tooltip"
                                data-placement="top" title="My Account"><i class="font-size-22 ec ec-user"></i></a></li>
                        <li class="col pr-xl-0 px-2 px-sm-3">
                            <a href="{{ route('cart') }}" class="text-gray-90 position-relative d-flex "
                                ...
                                <span
                                    class="bg-lg-down-black label_item_cart width-22 height-22 bg-primary position-absolute d-flex align-items-center justify-content-center rounded-circle left-12 top-8 font-weight-bold font-size-12">{{ count(Session('cart') ?? []) }}</span>
