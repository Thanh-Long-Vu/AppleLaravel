        ...
        <nav class="vertnav navbar navbar-light">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="Categories">
                <li class="nav-item dropdown">
                  ...
                  <ul class="collapse list-unstyled pl-4 w-100" id="Category">
                    ...
                    <li class="nav-item">
                      <a href="" data-toggle="collapse" aria-expanded="false" class="nav-link">
                        <span class="ml-3 item-text">Edit Category</span>
                      </a>
                    </li>
                  </ul>
                </li>
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="Categories">
                <li class="nav-item dropdown">
                  ...
                  <ul class="collapse list-unstyled pl-4 w-100" id="Products">
                    ...
                    <li class="nav-item">
                      <a href="" data-toggle="collapse" aria-expanded="false" class="nav-link">
                        <span class="ml-3 item-text">Edit Product</span>
                      </a>
                    </li>
                  </ul>
                </li>
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="Categories">
                <li class="nav-item dropdown">
                  ...
                  <ul class="collapse list-unstyled pl-4 w-100" id="Staff">
                    <li class="nav-item">
                      <a href="" data-toggle="collapse" aria-expanded="false" class="nav-link">
                        <span class="ml-3 item-text">List Staff</span>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="" data-toggle="collapse" aria-expanded="false" class="nav-link">
                        <span class="ml-3 item-text">Add Staff</span>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="" data-toggle="collapse" aria-expanded="false" class="nav-link">
                        <span class="ml-3 item-text">Edit Staff</span>
                      </a>
                    </li>
                  </ul>
                </li>
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="Categories">
                <li class="nav-item dropdown">
                  <a href="#Provider" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                    <i class="fe fe-box fe-16"></i>
                    <span class="ml-3 item-text">Provider</span>
                  </a>
                  <ul class="collapse list-unstyled pl-4 w-100" id="Provider">
                    <li class="nav-item">
                      <a href="" data-toggle="collapse" aria-expanded="false" class="nav-link">
                        <span class="ml-3 item-text">List Provider</span>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="" data-toggle="collapse" aria-expanded="false" class="nav-link">
                        <span class="ml-3 item-text">Add Provider</span>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="" data-toggle="collapse" aria-expanded="false" class="nav-link">
                        <span class="ml-3 item-text">Edit Provider</span>
                      </a>
                    </li>
                  </ul>
                </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="Blog">
                <li class="nav-item dropdown">
                  <a href="#Blogs_detail" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                    <i class="fe fe-box fe-16"></i>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="Trancastion">
                <li class="nav-item">
                  <a class="nav-link pl-3" href=""><i class="fe fe-pie-chart fe-16"></i></i><span class="ml-1 item-text">Orders</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href=""><i class="fe fe-pie-chart fe-16"></i><span class="ml-1 item-text">Goods Issue</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href=""><i class="fe fe-pie-chart fe-16"></i><span class="ml-1 item-text">Goods receipt</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href=""><i class="fe fe-pie-chart fe-16"></i><span class="ml-1 item-text">Inventory </span></a>
                </li>
              </ul>
            </li>
            <li class="nav-item dropdown">
