    ...
    <main role="main" class="main-content">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12">
                    <h2 class="mb-2 page-title">Data Brand</h2>
                    <div class="row my-4">
                        <!-- Small table -->
                        <div class="col-md-12">
                            <div class="card shadow">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <a class="btn btn-primary float-right ml-3" href="{{route('supplierCreate')}}">Create Silder</a>
                                    <!-- table -->
                                    <table class="table datatables" id="dataTable-1">
                                        ...
                                        <tbody>
                                            @foreach ($brand as $listSliderItem)
                                            <tr>
                                                <td  style=" text-align:center">{{$listSliderItem->id_brand}}</td>
                                                <td style=" text-align:center">{{$listSliderItem->name}}</td>
                                                <td style=" text-align:center">
                                                    <a class="btn mb-2 btn-outline-info" href="{{route('editSlider',['id'=>$listSliderItem->id_brand])}}">Edit</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
