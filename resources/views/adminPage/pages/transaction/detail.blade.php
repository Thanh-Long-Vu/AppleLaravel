            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10 col-xl-8">
                    <div class="row align-items-center mb-4">
                        <div class="col">
                            <h2 class="h5 page-title"><small class="text-muted text-uppercase">ID Transaction</small><br />#1806
                            </h2>
                        </div>
                        <div class="col-auto">
                        ...
                        <div class="card-body p-5">
                            <div class="row mb-5">
                                <div class="col-12 text-center mb-4">
                                    ...
                                    <p class="text-muted"> Name User <br /> Address User </p>
                                </div>
                                <div class="col-md-7">
                                    <p class="small text-muted text-uppercase mb-2">Invoice from</p>
                                    <p class="mb-4">
                                        <strong>Name Sell</strong><br /> Asset Management<br /> 9022 Suspendisse Rd.<br />
                                        High Wycombe<br /> (478) 446-9234<br />
                                    </p>
                                    <p>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <p class="mb-4">
                                        <strong>Name Receive</strong><br /> Phone (803) 792-2559<br /> Address <br />
                                    </p>
                                    <p>
